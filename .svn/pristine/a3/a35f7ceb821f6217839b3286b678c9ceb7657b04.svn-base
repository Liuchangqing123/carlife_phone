...
import com.didi365.carlife.android.phone.CrashHandler;
...
//    }
    ...
    public static void sendVideoCodecMsg(int width, int height, int frameRate) {
        ...
        carlifeCmdMessage.setData(videoInfo.toByteArray());
        carlifeCmdMessage.setLength(videoInfo.getSerializedSize());
...
//        builder.setCuid(CarlifeUtil.getInstance().getCuid());
    ...
    public static void sendModuleControlToHu(int moduleId, int statusId) {
        ...
        carlifeCmdMessage.setData(carlifeModuleStatus.toByteArray());
        carlifeCmdMessage.setLength(carlifeModuleStatus.getSerializedSize());
        AOAConnectManager.getInstance().writeCarlifeCmdMessage(carlifeCmdMessage);
    }
