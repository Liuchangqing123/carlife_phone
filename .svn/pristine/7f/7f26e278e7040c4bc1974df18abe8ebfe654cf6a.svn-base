...
public class ByteConvert {
    ...
    public static byte[] longToBytesLowbyte(long n) {
        byte[] result = new byte[4];
        result[0] = (byte) ((n & 0x7f000000) >> 24);
        result[1] = (byte) ((n & 0xff0000) >> 16);
        result[2] = (byte) ((n & 0xff00) >> 8);
        result[3] = (byte) ((n & 0xff) >> 0);
        return result;
    }
    ...
    public static byte[] intoByteLow(int n) {
        byte[] result = new byte[4];
