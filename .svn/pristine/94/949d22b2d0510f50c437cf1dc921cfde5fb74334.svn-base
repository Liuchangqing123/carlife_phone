...
public class CommonParams {
    ...
    public static final int SOCKET_LOCALHOST_COMMAND_PORT = 9400;
    ...
    public static final String SERVER_SOCKET_COMMAND_NAME = "Local_Cmd";
    ...
    public static String getMsgName(int serviceType) {
        ...
        int tmpValue;
        try {
            Class<?> cls = com.didi365.carlife.android.phone.util.CommonParams.class;
