            ...
            try {
                ...
                switch (msg.what) {
                    ...
                    case CommonParams.MSG_CMD_PROTOCOL_VERSION_MATCH_STATUS:
                        LogUtil.e(TAG, "MSG_CMD_PROTOCOL_VERSION_MATCH_STATUS");
                        if (ConnectManager.CONNECTED_BY_EAN == ConnectManager.getInstance().getConnectType()) {
                        ...
                        if (matchStatus == CommonParams.PROTOCOL_VERSION_MATCH) {
                            ...
                            if (!VehicleFactoryAdapter.getInstance().isContentEncrypt() || EncryptConfig.AES_ENCRYPT_AS_BEGINE) {
                                CarlifeUtil.sendVideoCodecMsg(mSurfaceView.getWidth(), mSurfaceView.getHeight(), 0);
                            }
                            ...
                            ConnectManager.getInstance().sendConnectTypeToMd(ModuleStatusModel.CARLIFE_CONNECT_MODULE_ID, ConnectManager.CONNECTED_TYPE);

                            if (CommonParams.VEHICLE_CHANNEL.equals(CommonParams.VEHICLE_CHANNEL_ROADROVER_MSTAR786_2)) {
                                CarlifeUtil.sendModuleControlToMd(ModuleStatusModel.CARLIFE_MIC_MODULE_ID, ModuleStatusModel.MIC_STATUS_USE_MOBILE_MIC);
                            }
                    ...
                    case CommonParams.MSG_CMD_VIDEO_ENCODER_INIT_DONE:
                        LogUtil.e(TAG, "MSG_CMD_VIDEO_ENCODER_INIT_DONE");
                    ...
                    case CommonParams.MSG_CMD_CAR_DATA_START_REQ:
                        ...
                        try {
                            CarlifeVehicleInfoProto.CarlifeVehicleInfo carlifeVehicleInfo = CarlifeVehicleInfoProto.CarlifeVehicleInfo.parseFrom(carlifeCarDataStart.getData());
                            ...
                            LogUtil.d(TAG, "CarDataStart Module =" + moduleId + "CarDataStart Flag =" + moduleFlag);
