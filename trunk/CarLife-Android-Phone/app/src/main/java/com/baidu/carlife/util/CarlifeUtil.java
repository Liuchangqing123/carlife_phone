...
import com.baidu.carlife.CrashHandler;
import com.baidu.carlife.connect.AOAConnectManager;
...
//    }
    ...
    public static void sendVideoCodecMsg(int width, int height, int frameRate) {
        ...
        carlifeMsg.setServiceType(CommonParams.MSG_CMD_VIDEO_ENCODER_INIT_DONE);
        ...
        CarlifeVideoEncoderInfoProto.CarlifeVideoEncoderInfo videoInfo = builder.build();
        carlifeMsg.setData(videoInfo.toByteArray());
        carlifeMsg.setLength(videoInfo.getSerializedSize());
    ...
    public static void sendStatisticsInfo(int connect_time) {
        ...
        CarlifeStatisticsInfoProto.CarlifeStatisticsInfo.Builder builder = CarlifeStatisticsInfoProto.CarlifeStatisticsInfo.newBuilder();
//        builder.setCuid(CarlifeUtil.getInstance().getCuid());
        ...
        CarlifeStatisticsInfoProto.CarlifeStatisticsInfo statisInfo = builder.build();
    ...
    public static void sendModuleControlToHu(int moduleId, int statusId) {
        CarlifeModuleStatusProto.CarlifeModuleStatus.Builder moduleStatusBuilder = CarlifeModuleStatusProto.CarlifeModuleStatus.newBuilder();
        moduleStatusBuilder.setModuleID(moduleId);
        moduleStatusBuilder.setStatusID(statusId);
        CarlifeModuleStatusProto.CarlifeModuleStatus carlifeModuleStatus = moduleStatusBuilder.build();
        CarlifeCmdMessage carlifeMsg = new CarlifeCmdMessage(true);
        carlifeMsg.setServiceType(CommonParams.MSG_CMD_MODULE_STATUS);
        carlifeMsg.setData(carlifeModuleStatus.toByteArray());
        carlifeMsg.setLength(carlifeModuleStatus.getSerializedSize());
