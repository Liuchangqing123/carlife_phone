...
public class AudioPlayerUtil {
    ...
    public void startDecode() {
        ...
        if (musicPCMReceiveThread == null) {
            ...
            musicPCMReceiveThread.setName("AudioPlayerThread");
    ...
    private class MusicPCMThread extends Thread {
        ...
        public void run() {
            ...
            int ret = -1;
            if (ConnectManager.getInstance().getConnectType() == ConnectManager.CONNECTED_BY_USBMUXD) {
                UsbMuxdConnectManager.getInstance().writeAudioData(mediaDate, mediaDate.length);
            }
            while (isRunning) {
                ...
                if (ConnectManager.getInstance().getConnectType() == ConnectManager.CONNECTED_BY_AOA) {
                    ...
                    UsbMuxdConnectManager.getInstance().writeAudioData(inputData, lenMsgHead + lenMsgData);
                }
            }
        }
    }
