...
public class ConnectServiceReceiver extends BroadcastReceiver {
    ...
    public static final String CARLIFE_CONNECT_SERVICE_START = "com.baidu.carlife.connect.ConnectServiceStart";
    public static final String CARLIFE_CONNECT_SERVICE_STOP = "com.baidu.carlife.connect.ConnectServiceStop";
