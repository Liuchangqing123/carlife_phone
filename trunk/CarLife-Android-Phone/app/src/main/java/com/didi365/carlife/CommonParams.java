...
public class CommonParams {
     ...
     * carlife与喵驾的控制消息
     */
    public static final int MIU_MSG_CMD_HEAD_SIZE_BYTE = 1;
    public static final int MIU_MSG_CMD_HEAD_SIZE = 5;
    public static final int MIU_MSG_CMD_TYPE_FIX = 0x00FF55AA;

    public static final int MIU_MSG_CMD_KEY_BACK = 0x00000001;
    public static final int MIU_MSG_CMD_KEY_UP = 0x00000002;
    public static final int MIU_MSG_CMD_KEY_DOWN = 0x00000003;
    public static final int MIU_MSG_CMD_KEY_LEFT = 0x00000004;
    public static final int MIU_MSG_CMD_KEY_RIGHT = 0x00000005;
    public static final int MIU_MSG_CMD_KEY_OK = 0x00000006;
    public static final int MIU_MSG_CMD_SCROLL_RIGHT = 0x00000007;
    public static final int MIU_MSG_CMD_SCROLL_LEFT = 0x00000008;
    public static final int MIU_MSG_CMD_MEDIA_PRE = 0x00000009;
    public static final int MIU_MSG_CMD_MEDIA_NEXT = 0x0000000A;
    public static final int MIU_MSG_CMD_MEDIA_PLAY_AND_PAUSE = 0x0000000B;
    public static final int MIU_MSG_CMD_LONG_PRESS = 0x0000000C;
    public static final int MIU_MSG_CMD_SCROLL_RIGHT_MORE = 0x0000000D;
    public static final int MIU_MSG_CMD_SCROLL_LEFT_MORE = 0x0000000E;
    public static final int MIU_MSG_CMD_VOICE_SIRI = 0x0000000F;
    public static final int MIU_MSG_CMD_AUDIO_FOCUS_MIUDRIVE = 0x00000010;
    public static final int MIU_MSG_CMD_AUDIO_FOCUS_VIHICLE = 0x00000011;
    public static final int MIU_MSG_CMD_EVENT_VOICE_END = 0x00000012;
    public static final int MIU_MSG_CMD_EVENT_MIC_SUCCESS = 0x00000013;

    public static final int MIU_MSG_CMD_MEDIA_PAUSE = 0x000000F1;
    public static final int MIU_MSG_CMD_PHONE_CALL = 0x000000F2;
    public static final int MIU_MSG_CMD_PHONE_HUANG_UP = 0x000000F3;
    public static final int MIU_MSG_CMD_PHONE_CALLING = 0x000000F4;
    public static final int MIU_MSG_CMD_PHONE_RING = 0x000000F5;
    public static final int MIU_MSG_CMD_NAVI_VOICE_END = 0x000000F6;
    public static final int MIU_MSG_CMD_NAVI_VOICE_START = 0x000000F7;
    public static final int MIU_MSG_CMD_MEDIA_PLAY = 0x000000F8;
    public static final int MIU_MSG_CMD_VOICE_DOWN = 0x000000F9;
    public static final int MIU_MSG_CMD_VOICE_UP = 0x000000FA;
    public static final int MIU_MSG_CMD_MAP_OUT = 0x000000FB;
    public static final int MIU_MSG_CMD_MAP_IN = 0x000000FC;
    public static final int MIU_MSG_CMD_VEHICLE_BACK = 0x000000FE;

    public static final int MIU_MSG_CMD_GPS_DATA = 0x000000FF;
    ...
    public static final int MSG_ANDROID_DEBUG_CONNECT_STATUS_LISTENED = 10042;
    ...
    public static final String SD_DIR_NAME = "DiDiCarlife";
    ...
    public static final int SOCKET_MIUDRIVE_PORT = 36039;
    public static final int SOCKET_MIUDRIVE_VR = 36049;
    ...
    public static final int SOCKET_ANDROID_DEBUG_LOCAL_PORT = 7240;
    public static final int SOCKET_ANDROID_DEBUG_VIDEO_PORT = 8240;
    ...
    public static final String SERVER_SOCKET_MIUDRIVE_NAME = "Miudrive";
    public static final String SERVER_SOCKET_MIUDRIVE_VR_NAME = "Miudrive_VR";
    public static final String SERVER_SOCKET_ANDROID_DEBUG_NAME = "AndroidDebug_Name";
    public static final String SERVER_SOCKET_ANDROID_DEBUG_VIDEO = "AndroidDebug_Video";
